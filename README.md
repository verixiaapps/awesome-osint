...
* [HostDeFi Token Safety Scanner](https://hostdefi.com/scan) - Keyless web scanner and REST API grading Solana + 7 EVM-chain tokens A+–F from on-chain risk signals (mint/freeze authority, liquidity, holder concentration). Useful for investigating tokens and contracts.
